...
def Scores(win, coordinate):
    scores_appearing = coordinate
    win.blit(OFFLINEGAME.SCORES, scores_appearing[:2])
...
def showDices(dices):
    ...
    for i in range(0, 11):
        ...
        emptyRoundRect(win, (255, 255, 255), (650, 43, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 90, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 138, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 185, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 232, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 279, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 326, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 373, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 420, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 467, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 514, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 561, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 608, 510, 50), 7, 5)
        emptyRoundRect(win, (255, 255, 255), (650, 655, 510, 50), 7, 5)
        ...
        for i, sName in enumerate(strategies_order):
            ...
            nText = fvsmall.render(n_text, 1, WHITE)
            sText = fvsmall.render(s_text, 1, WHITE)
            win.blit(nText, (780, 47 * (i + 1)+15))
            win.blit(sText, (980, 47 * (i + 1)+15))
            #loader 연동중
            #Scores(win, (980, 47 * (i + 1)+15))
            pygame.display.update()
